...
## Done summary
Added platform-aware path normalization helper to fix macOS Docker volume mount failures with symlinked paths. On macOS, paths now use pwd -L to preserve symlinks for Lima mount compatibility; on Linux/WSL, paths use pwd -P for consistency.
## Evidence
- Commits: 0258b4b453688ea9f4caf3d791601cacb913be5d
- Tests: shellcheck -x src/*.sh src/lib/*.sh, source src/containai.sh && _cai_normalize_path /home/agent/workspace
- PRs:
