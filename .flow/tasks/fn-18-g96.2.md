...
## Done summary
Added --container parameter to shell, run, import, export, and stop commands for explicit container targeting. Links command retains --name for different semantics. The _cai_find_container_by_name helper searches configured/secure contexts first, deriving workspace/volume from container labels. Added mutual exclusivity checks for --container with --workspace/--data-volume.
## Evidence
- Commits: 8955caaefb3b8987f021ee71c7885f22398a8f20, 8e74b53f1acdaefc4d8de844244e19dcf2e61082
