...
## Done summary
Improved --container multi-context lookup by adding _cai_find_container_by_name helper that searches configured/secure contexts first. Fixed error messages to reference --container instead of --name.
## Evidence
- Commits: 240b4c3, 3f759d7
- Tests: shellcheck -x src/lib/container.sh src/containai.sh
- PRs:
