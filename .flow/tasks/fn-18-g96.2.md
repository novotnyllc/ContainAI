...
## Done summary
Renamed --name to --container on run, shell, import, export, and stop commands. Added container label-based resolution for import/export --container mode. Implemented mutual exclusivity checks and multi-context search for stop/shell.
## Evidence
- Commits: 401b2029f7fb8d191565ec8ad4135e4912e851d4, 53ad2ef, 5c27099, e84093c
- Tests: shellcheck -x src/containai.sh
- PRs:
