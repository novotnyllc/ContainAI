...
Analyzed 51 devcontainer.json files sampled from popular GitHub repositories (50 parsed successfully). All frequency statistics use N=50.
...
- 50 devcontainer.json files analyzed (1 parse failure excluded)
- Property frequency table with percentages
- Feature usage statistics
