...
## Done summary
Added comprehensive ACP integration documentation with usage guide, editor configuration (Zed, VS Code), MCP server handling details, troubleshooting section, and CLI help text for the --acp flag.
## Evidence
- Commits: 57bfdc1ff903cb653ce24d60a0935a90fc8082c4
