...
export CONTAINAI_AGENT_NAME="$AGENT_NAME"
export CONTAINAI_AGENT_BINARY="$AGENT_BINARY"
export CONTAINAI_AGENTCLI_WRAPPER=1
export CONTAINAI_AGENTCLI_SECRETS="/run/agent-secrets/__AGENT_NAME__"
export CONTAINAI_AGENTCLI_DATA="/run/agent-data/__AGENT_NAME__"
