...
AGENT_CLI_CAP_ROOT="${CODING_AGENTS_AGENT_CAP_ROOT:-/run/coding-agents/copilot/cli/capabilities}"
...
MERGE_SCRIPT="${CODING_AGENTS_COPILOT_MERGE_SCRIPT_OVERRIDE:-/usr/local/bin/merge-copilot-tokens.py}"
