...
- **Tooling Policy**: Tier 1 actions (edit, tests, formatting) silent; Tier 2 (package install, git push local, high-volume fetch) logged & rate-limited; Tier 3 (git push origin, new domain allowlist entries, host credential requests) require explicit user confirmation.
