...
internal static class ImportAdditionalPathSymlinkBoundaryValidator
{
    public static bool TryValidate(string rawPath, string effectiveHome, string fullPath, out string? warning)
    {
