...
internal static class DockerProxyArgumentParsing
{
    ...
    public static string SanitizeWorkspaceName(string value) => DockerProxyValidationHelpers.SanitizeWorkspaceName(value);
