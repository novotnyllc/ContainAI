...
internal sealed class CaiDiagnosticsAndSetupOperations : CaiRuntimeSupport
{
    ...
    public CaiDiagnosticsAndSetupOperations(
        ...
        => this.runSshCleanupAsync = runSshCleanupAsync;
        ...
        CancellationToken cancellationToken)
    {
        ...
        var doctorExitCode = await RunDoctorAsync(outputJson: false, buildTemplates: false, resetLima: false, cancellationToken).ConfigureAwait(false);
        if (doctorExitCode != 0)
        {
