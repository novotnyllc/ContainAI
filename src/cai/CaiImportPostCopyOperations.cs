    ...
    , IImportPostCopyOperations
{
    ...
    {
        secretPermissionOperations = importSecretPermissionOperations ?? throw new ArgumentNullException(nameof(importSecretPermissionOperations));
        gitConfigFilterOperations = importGitConfigFilterOperations ?? throw new ArgumentNullException(nameof(importGitConfigFilterOperations));
    }
