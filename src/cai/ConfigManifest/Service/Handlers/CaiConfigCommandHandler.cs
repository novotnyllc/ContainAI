...
internal sealed class CaiConfigCommandHandler
{
    private readonly IConfigCommandProcessor configCommandProcessor;

    public CaiConfigCommandHandler(IConfigCommandProcessor processor)
        => configCommandProcessor = processor ?? throw new ArgumentNullException(nameof(processor));
