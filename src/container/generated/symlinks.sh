...
if ! touch /mnt/agent-data/.write-test 2>/dev/null; then
    printf 'ERROR: /mnt/agent-data is not writable by %s\n' "$(id)" >&2
    ls -la /mnt/agent-data 2>&1 || printf '/mnt/agent-data does not exist\n' >&2
    exit 1
fi
...
run_cmd ln -sfn -- "/mnt/agent-data/git/gitconfig" "/home/agent/.gitconfig"
...
run_cmd ln -sfn -- "/mnt/agent-data/shell/zshenv" "/home/agent/.zshenv"
