...
| Env detection & integrity gating             | `test-launchers.sh::test_env_detection_profiles`, `test_integrity_check_behaviors`                               | Profiles dev vs prod and enforces SHA256SUMS in prod. |
